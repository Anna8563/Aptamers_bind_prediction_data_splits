...
from src.models.screening import screen_multimodel_optuna_apt
...
checkpoint_dir = root / "notebooks" / "notebooks" / "checkpoints_aptamers_2"
...
results_dir = root / "notebooks" / "results" / "only_aptamers"
...
for split_path in tqdm(sorted(splits_dir.glob("split_*")), desc="Evaluate splits"):
    ...
    for model_cfg in model_cfgs:
        for split_mode in ["stratified", "disjoint_protein", "disjoint_aptamer"]:
            ...
            try:
                results_df = screen_multimodel_optuna_apt(
                    df,
                    apt_cfgs,
                    model_cfg=model_cfg,
    ...
    if all_results:
        ...
        results_path = checkpoint_dir / 'multimodel_results_screening_complete_only_aptamers.csv'
